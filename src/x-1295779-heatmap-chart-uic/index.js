...
const getContainer = (host) =>
	host && host.shadowRoot
		? host.shadowRoot.querySelector(".hc-root") ||
...
const hasData = (d) => {
	...
	if (d && typeof d === "object" && Array.isArray(d.cells))
...
createCustomElement("x-2114311-heatmap-chart-uic", {
	...
	properties: {
		...
		customColorStart: { default: "#ebedf0" },
		customColorEnd: { default: "#216e39" },
		...
		tooltipTemplate: {
			default: "{swatch}<strong>{x} · {y}</strong><br/>{formattedValue}",
		},
